...
#         self._linear1 = nn.Linear(d_output*30, 10)
        self._linear_out = nn.Linear(d_output*self.train_window, 1)
...
#         print(output.shape)
        output = output.view(-1, 1*self.train_window)
#         print(output.shape)
#         output = self._linear1(output) 
#         output = self._relu(output)
        output = self._linear_out(output)
        output = torch.sigmoid(output) #tanh(output)#sigmoid(output)
        return output
